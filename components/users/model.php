...
/* ==================================================================================================== */
    ...
    public function addUploadedPhoto($user_id, $photo) {
        ...
        $id = $this->inDB->get_last_id('cms_user_photos');
...
/* ==================================================================================================== */
    ...
    public function initUploadClass() {
        ...
        $inUploadPhoto->upload_url    = '/images/users/photos/';
        $inUploadPhoto->upload_dir    = PATH. $inUploadPhoto->upload_url;
        $inUploadPhoto->small_size_w  = 96;
        $inUploadPhoto->medium_size_w = 600;
        $inUploadPhoto->thumbsqr      = 1;
        $inUploadPhoto->is_watermark  = $this->config['watermark'];
        $inUploadPhoto->is_saveorig   = 0;
